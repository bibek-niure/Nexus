...
async function Page({ params }: { params: { id: string } }) {
  ...
  const echo = await fetchEchoById(params.id); // Fetching echo by ID
  ...
  console.log('Sentiment from fetched echo:', echo.sentiment);
    ...
    <section className="relative">
      <div>
        <EchoCard
          ...
          sentiment={echo.sentiment}  // Passing sentiment to EchoCard
        />
      </div>
      ...
      <div className="mt-10">
        {echo.children.map((childItem: any, idx: number) => (
          <EchoCard
            ...
            sentiment={childItem.sentiment}  // Passing sentiment to child EchoCard
            isComment
          />
        ))}
      </div>
